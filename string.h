...
extern "C" CRTIMP size_t wcslen(const wchar_t* wcs) NOTHROW;
extern "C" int strcmp(const char * str1, const char * str2) NOTHROW;
extern "C" CRTIMP int strncmp(const char * str1, const char * str2, size_t num) NOTHROW;
extern "C" CRTIMP int tolower(int ch) NOTHROW;
