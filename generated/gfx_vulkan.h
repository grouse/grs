...
extern u32 hash32(const GfxTextureAssetDesc & it, u32 seed = HASH32_SEED);
extern u32 hash32(const GfxVkBuffer & it, u32 seed = HASH32_SEED);
extern u32 hash32(const GfxVkTexture & it, u32 seed = HASH32_SEED);
extern u32 hash32(const GfxVkDescriptorDesc & desc, u32 seed = HASH32_SEED);
extern u32 hash32(const GfxVkDescriptorSetDesc & desc, u32 seed =HASH32_SEED);
extern u32 hash32(const VkDescriptorSetLayoutCreateInfo & info, u32 seed = HASH32_SEED);
