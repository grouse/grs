...
extern bool add_log_sink(sink_proc_t sink, void *sink_data);
...
extern bool add_log_sink(sink_proc_t sink, void *user_data);
extern void file_log_sink(void *sink_data, const char *path, u32 line, LogType type, const char *msg);
