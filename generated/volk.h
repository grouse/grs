...
extern void volkLoadInstanceTable(struct VolkInstanceTable *table, VkInstance instance);
...
static void volkGenLoadInstanceTable(struct VolkInstanceTable *table, void *context, PFN_vkVoidFunction (*)(void *, const char *)load);
