...
GfxMesh gfx_ramp(f32 length, f32 height, f32 width)
{
    ...
    Vector3 top_n = normalise(Vector3{ 0, length, height });
    ...
    MeshVertex vertices[] = {
        ...
        // right face
        { { hw, hh,  -hl }, { 1, 1 }, { 1, 0, 0 }, { 0, 1, 0, -1 } },
        { { hw, -hh, hl  }, { 0, 0 }, { 1, 0, 0 }, { 0, 1, 0, -1 } },
        { { hw, -hh, -hl }, { 0, 1 }, { 1, 0, 0 }, { 0, 1, 0, -1 } },

        // left face
        { { -hw, hh,  -hl }, { 1, 1 }, { -1, 0, 0 }, { 0, 0, -1, -1 } },
        { { -hw, -hh, -hl }, { 1, 0 }, { -1, 0, 0 }, { 0, 0, -1, -1 } },
        { { -hw, -hh, hl  }, { 0, 0 }, { -1, 0, 0 }, { 0, 0, -1, -1 } },
